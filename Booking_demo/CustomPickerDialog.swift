...
class CustomPickerDialog: UIView {
    ...
    private func createDialogView() -> UIView {
        ...
        // Button
        let buttonWidth = dialogContainer.bounds.size.width / 2 - 8
        
        self.cancelButton = UIButton(type: UIButtonType.Custom) as UIButton
        self.cancelButton.frame = CGRectMake(4, dialogContainer.bounds.size.height - buttonHeight, buttonWidth, buttonHeight)
        self.cancelButton.setTitleColor(UIColor(hexString: "#3399FF"),  forState: UIControlState.Normal)
        ...
        //self.cancelButton.layer.backgroundColor = UIColor(hexString: "#3399FF").CGColor
        ...
        self.doneButton.frame = CGRectMake(buttonWidth + 12, dialogContainer.bounds.size.height - buttonHeight, buttonWidth, buttonHeight)
        self.doneButton.setTitleColor(UIColor(hexString: "#3399FF"), forState: UIControlState.Normal)
        ...
        //self.doneButton.layer.backgroundColor = UIColor(hexString: "#3399FF").CGColor
        ...
        self.doneButton.addTarget(self, action: #selector(HotelCollectionViewController.clickButton(_:)), forControlEvents: UIControlEvents.TouchUpInside)
