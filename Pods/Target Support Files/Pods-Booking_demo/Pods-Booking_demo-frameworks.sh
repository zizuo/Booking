...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CVCalendarKit/CVCalendarKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/CXDurationPicker/CXDurationPicker.framework"
  install_framework "$BUILT_PRODUCTS_DIR/CXTabView/CXTabView.framework"
